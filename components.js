...
const projectImages = {
    ...
    rost: [
        ...
        'Images/ROST UXUI design/ROST (9).webp',
        'Images/ROST UXUI design/ROST (10).webp',
        'Images/ROST UXUI design/ROST (11).webp'
    ],
    tomo: [
        'Images/TŌMO UXUI/TOMO.webp',
        'Images/TŌMO UXUI/TOMO (1).webp',
        'Images/TŌMO UXUI/TOMO (2).webp',
        'Images/TŌMO UXUI/TOMO (3).webp',
        'Images/TŌMO UXUI/TOMO (4).webp',
        'Images/TŌMO UXUI/TOMO (5).webp',
        'Images/TŌMO UXUI/TOMO (6).webp',
        'Images/TŌMO UXUI/TOMO (7).webp',
        'Images/TŌMO UXUI/TOMO (8).webp'
    ]
};
...
function initLightbox() {
    ...
    const updateImage = () => {
        ...
        if (list && list[currentImageIndex]) {
            // Apply fade-out/scale-down loading state
            img.classList.add('loading');
            
            // Preload next image in background
            const tempImg = new Image();
            tempImg.src = list[currentImageIndex];
            tempImg.onload = () => {
